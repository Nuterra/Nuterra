...
namespace Maritaria
{
	public class ProductionToggleKeyBehaviour : Singleton.Manager<ProductionToggleKeyBehaviour>
	{
		...
		public void Update()
		{
			if (Input.GetKeyDown(Mod.Config.ProductionToggleKey))
			{
		...
		public static void ModuleItemPickup_OnSpawn(ModuleItemPickup pickup)
		{
		...
		public static void ModuleItemPickup_OnAttach(ModuleItemPickup pickup)
		{
			Singleton.Manager<ProductionToggleKeyBehaviour>.inst.ModuleItemPickup_ApplyProductionToggle(pickup);
		}
		...
		public static bool ModuleHeart_get_IsOnline(ModuleHeart heart)
		{
